...
# Search for "unpacking" directory backward with a timeout of 5 seconds
search_and_set_directory_or_file 5 "ROOT" "ROOT_ROOT" "d" ""

# Search for "unpacking" directory backward with a timeout of 5 seconds
search_and_set_directory_or_file 5 "unpacking" "UNPACKING_ROOT" "d" ""
...
# Search for "boost" directory backward with a timeout of 5 seconds
search_and_set_directory_or_file 5 "boost-1.70.0" "BOOST_1_70_0_ROOT" "d" ""

# Search for "zeroMQ" directory backward with a timeout of 5 seconds
search_and_set_directory_or_file 5 "zeroMQ" "ZEROMQ_ROOT" "d" ""
...
echo "UNPACKING_ROOT=$UNPACKING_ROOT" >> environment_variables.txt
echo "ROOT_ROOT=$ROOT_ROOT" >> environment_variables.txt
